...
t0 = 0;
yp0 = [0 0 0 0 ]; % guess for initial values of derivatives
options=odeset('RelTol',1e-6);
[y0,yp0] = decic(@dynamics,t0,IC,[1 1 1 1],yp0,[0 0 0 0],options,InitialPop,oxygen1,oxygen2,MCT41,MCT42);
...
[t,y]=ode15i(@dynamics,tspan,y0,yp0,options,InitialPop,oxygen1,oxygen2,MCT41,MCT42);
...
function deriv = dynamics(t,y,yp,InitialPop,oxygen1, oxygen2,MCT41,MCT42)


    deriv=zeros(4,1); % create an empty column vector
