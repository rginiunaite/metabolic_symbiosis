...
T = 2e1;           % Sets the end of time interval
tspan = [0 T];
...
function deriv = dynamics(t,y,yp,InitialPop,MCT41,MCT42,MCT11,MCT12)
    ...
    deriv(1) = yp(1) - (Sl1 -  MCT41 * y(1) + MCT11 * y(2) - k51 * y(1) * y(3) ); % 1st compartment
    
    deriv(2) = yp(2) - (Sl2 - MCT42 *y(2) + MCT12 * y(1) - k51 * y(2) * y(4)); % 2nd compartment
...
% population 2
 ...
 % oxygen 2
    ...
    deriv(7) = yp(7) - ( Sg1 - GL1 * y(7) + GL2 * y(8) - k4 * (y(7) * y(3)));
    
    deriv(8) = yp(8) - ( Sg2 + GL1 * y(7) - GL2 * y(8) - k4 * (y(8) * y(4)));
