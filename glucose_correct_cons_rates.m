...
T = 2.84;           % Sets the end of time interval
tspan = [0 T];
...
function deriv = dynamics(t,y,yp,InitialPop,MCT41,MCT42,MCT11,MCT12)
    ...
    k6 = 100; % how much oxygen is used by cells
    ...
    Sg1 = 1000;
    Sg2 = 0;
    GL1 = 1000; % glucose diffusion from the first to the second compartment
    GL2 = 0; % glucose diffusion from the second to the first compartment
    k4 = 1; % glucose consumption
    KG = 1;
    gamL = 1;
...
function value = birth3 (oxygen,lactate)
    ...
    value = a0 * ((oxygen^1.5*lactate/oxycr)-1)^exponent; % changed oxygen power to 1.5 to ensure that lactate is much more beneficial if there is a lot of oxygen
    value = 1/value;
end
%%%
